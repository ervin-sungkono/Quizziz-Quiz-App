...
export default function Button({ 
        ...
        switch(variant){
            case 'primary':
                return ({
                    ...
                    outlineTextColor: 'text-primary-orange',
                    borderClass: 'border-primary-orange',
                    hover: 'hover:bg-primary-orange/80',
                    hoverOutline: 'hover:bg-primary-orange hover:text-white'
                })
            case 'secondary':
                return ({
    ...
    const getSizeClass = () => {
        switch(size){
            case 'md':
                return 'text-sm md:text-base px-4 md:px-6 py-2 md:py-3 rounded-md'
            case 'sm':
                return 'text-xs md:text-sm px-3 md:px-4 py-1.5 md:py-2 rounded'
        }
    }
